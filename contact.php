...
$db_name = "mysql:host=localhost;dbname=edoc";
$username = "root";
$password = "";
...
if(isset($_POST['send'])){
   ...
   $select_message = $conn->prepare("SELECT * FROM `message` WHERE name = ? AND email = ? AND subject = ? AND message = ?");
   ...
   if($select_message->rowCount() > 0){
      ...
      $insert_message->execute([$name, $email, $subject, $msg]);
            ...
            <div class="row g-5">
                    ...
                    <div class="bg-light rounded h-100 p-5">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="text-start">
                                ...
                                <span>Mulago Hill, P.O.Box 7051, Kampala Uganda</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="text-start">
                                ...
                                <span>admin@mulagohospital.go.ug</span>
                            </div>
                        </div>
                ...
                <?php
                    ...
                    <form action="" method="POST">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <textarea name="msg" class="form-control border-0 bg-light px-4 py-3" rows="5" placeholder="Message"></textarea>
                            </div>
                            <div class="col-12">
                ...
                <div class="col-xl-4 col-lg-12 wow slideInUp" data-wow-delay="0.6s">
                    <iframe class="position-relative rounded w-100 h-100"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15958.975391266185!2d32.56089032670113!3d0.3500739459133903!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x177dbbcf889a0acf%3A0x4a6191fa3776c1fd!2sMulago%20National%20Referral%20Hospital!5e0!3m2!1sen!2sug!4v1681896235654!5m2!1sen!2sug"
            ...
            <div class="row g-5 pt-4">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Mulago Hospital</a>
                        <a class="text-light mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Deaf Community</a>
                        <a class="text-light" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Deaf Schools</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
